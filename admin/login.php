...
if (isset($_POST['email'])) {
    ...
    $cek = ambilData("SELECT * FROM pengurus WHERE email = '{$email}'");
    if ($cek) {
        $cek = $cek[0];
    ...
    $cek = ambilData("SELECT * FROM wali_santri WHERE email = '{$email}'");
    if ($cek) {
        $cek = $cek[0];
...
<head>
    ...
    <title>Login Ponpes Nurul Iman</title>
